		...
		try {
			...
			if (storeDataResult) {
				...
				setFormData({
					...
					trading_name: storeDataResult.trading_name || "",
					business_address: storeDataResult.business_address || "",
					business_phone: storeDataResult.business_phone || "",
					business_registration_number:
	...
	const handleAutoSave = useCallback(async () => {
		...
		try {
			await updateStoreDataAPI(store.id, {
				...
				trading_name: debouncedFormData.trading_name,
				business_address: debouncedFormData.business_address,
				business_phone: debouncedFormData.business_phone,
				business_registration_number:
